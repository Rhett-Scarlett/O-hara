...
public class ColumnSorterIDExcludeUnique {
    public void ExternalSortID(String inputFilePath, String outputFilePath, int chunkSize, int length, int unqiue) {
        // 用于存放所有临时文件的列表
        ...
        try {
            ...
            mergeSortedIDFiles(tempFiles, outputFilePath, tempFilesSize, length-unqiue);
            // 临时排序完成后，删除所有临时文件
    ...
    private void mergeSortedIDFiles(List<File> files, String outputFilePath, List<Integer> filesSize, int non_unqiue) throws IOException {
